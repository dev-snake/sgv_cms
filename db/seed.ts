...
async function main() {
    ...
    const appModules = [
        ...
        { code: 'LOGS', name: 'Logs', icon: 'History', route: '/portal/audit-logs', order: 13 },
        {
            code: 'SETTINGS',
        ...
        if (sensorCat) {
            await db
                ...
                .values({
                    ...
                    description:
                        'Cảm biến độ đục áp dụng công nghệ sợi quang và nguyên lý tán xạ ánh sáng của góc phát hiện 90° để có dữ liệu ổn định hơn.',
                    sku: 'SGVT-400-SERIES',
                    price: '0.00',
                    stock: 20,
                    ...
                    tech_specs: [
                        {
                            'Thông số': 'Sản phẩm',
                            'Model SGVT410': 'Cảm biến độ đục sợi quang',
                            'Model SGVT420': 'Cảm biến độ đục tự làm sạch',
                        },
                        {
                            'Thông số': 'Model',
                            'Model SGVT410': 'SGVT410',
                            'Model SGVT420': 'SGVT420',
                        },
                        {
                            'Thông số': 'Phương pháp đo',
                            'Model SGVT410': 'Tán xạ ánh sáng 90°',
                            'Model SGVT420': 'Tán xạ ánh sáng 90°',
                        },
                        {
                            'Thông số': 'Phạm vi đo',
                            'Model SGVT410': '0〜1000 NTU',
                            'Model SGVT420': '0〜1000 NTU',
                        },
                        {
                        ...
                        {
                            'Thông số': 'Cấp độ bảo vệ',
                            'Model SGVT410': 'IP68',
                            'Model SGVT420': 'IP68',
                        },
                        {
                            'Thông số': 'Giao diện',
                            'Model SGVT410': 'RS485, Modbus',
                            'Model SGVT420': 'RS485, Modbus',
                        },
                        {
                            'Thông số': 'Lắp đặt',
                            'Model SGVT410': 'Gắn và trong',
                            'Model SGVT420': 'Gắn và trong',
                        },
                        {
                            'Thông số': 'Nguồn điện',
                            'Model SGVT410': 'DC 6〜12V, <50mA',
                            'Model SGVT420': 'DC 6〜12V, <50mA',
                        },
                        {
                            'Thông số': 'Kích cỡ',
                            'Model SGVT410': 'Φ32*152.5mm',
                            'Model SGVT420': 'Φ32*169.5mm',
                        },
                        {
                            'Thông số': 'Chiều dài cáp',
                            'Model SGVT410': '5m (tùy chỉnh)',
                            'Model SGVT420': '5m (tùy chỉnh)',
                        },
                        {
                            'Thông số': 'Chất liệu vỏ',
                            'Model SGVT410': 'POM',
                            'Model SGVT420': 'POM',
                        },
                        {
                            'Thông số': 'Đầu dò quang',
                            'Model SGVT410': 'Sợi quang',
                            'Model SGVT420': 'Sợi quang',
                        },
                        {
                            'Thông số': 'Bàn chải tự làm sạch',
                            'Model SGVT410': 'Không',
                            'Model SGVT420': 'Có',
                        },
                    ],
                    tech_summary:
                        'Cảm biến kỹ thuật số thế hệ mới, tích hợp RS485 và bàn chải tự làm sạch giúp duy trì độ chính xác cao trong môi trường nước khắc nghiệt.',
                })
                .onConflictDoNothing();
        }
    }
        ...
        if (generalCat && author) {
            await db
                ...
                .values({
                    ...
                    summary:
                        'Sài Gòn Valve tự hào giới thiệu các giải pháp van công nghiệp và thiết bị đo thông minh tại Vietwater 2024.',
                    content:
                        '<p>Vietwater là triển lãm lớn nhất ngành nước tại Việt Nam. Năm nay, Sài Gòn Valve mang đến các dòng van bướm OKM, van bi điều khiển điện và các cảm biến đo chất lượng nước IoT thế hệ mới.</p><p>Chúng tôi tập trung vào giải pháp tối ưu hóa vận hành và tiết kiệm năng lượng cho các nhà máy cấp thoát nước.</p>',
        ...
        if (technicalCat && author) {
            await db
                ...
                .values({
                    ...
                    summary:
                        'Làm thế nào để phân biệt và lựa chọn đúng tiêu chuẩn mặt bích JIS và ANSI cho hệ thống đường ống?',
                    content:
                        '<p>Việc lựa chọn sai tiêu chuẩn mặt bích có thể dẫn đến rò rỉ và hỏng hóc hệ thống. Bài viết này sẽ giúp bạn hiểu rõ sự khác biệt giữa tiêu chuẩn JIS (Nhật Bản) và ANSI (Hoa Kỳ).</p><ul><li>Kích thước lỗ bu lông</li><li>Độ dày mặt bích</li><li>Áp suất định mức</li></ul>',
