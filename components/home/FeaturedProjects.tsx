      ...
      <section className="bg-slate-50 py-24 sm:py-32">
        <div className="container mx-auto px-4 lg:px-8">
           <div className="h-[450px] flex flex-col items-center justify-center space-y-4">
              ...
              <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Đang tải dự án...</p>
           </div>
        </div>
      </section>
    );
      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {projects.map((project, i) => (
            ...
            >
              <Image
                src={project.image_url || "https://saigonvalve.vn/uploads/files/2024/06/12/Blue-and-White-Clean-Modern-Technology-Conference-Zoom-Virtual-Background-2-.png"}
                alt={project.name}
                fill
              ...
              <div className="absolute inset-0 flex flex-col justify-end p-8 space-y-4">
                 ...
                 <div className="text-xs font-medium text-slate-300 line-clamp-2 opacity-0 group-hover:opacity-100 translate-y-4 group-hover:translate-y-0 transition-all duration-500" 
                      dangerouslySetInnerHTML={{ __html: project.description }} />
              </div>

              <Link href={`/du-an/${project.slug}`} className="absolute inset-0 z-10" />
            </motion.div>
          ))}
        </div>
