        ...
        <div className="flex items-center gap-3">
          ...
          <Tabs value={viewMode} onValueChange={(v) => setViewMode(v as any)} className="bg-slate-100 p-1 rounded-none border border-slate-200">
            <TabsList className="bg-transparent h-10 gap-1 rounded-none shadow-none p-0 ">
              <TabsTrigger value="edit" className="rounded-none data-[state=active]:bg-white hover:cursor-pointer data-[state=active]:text-brand-primary data-[state=active]:shadow-sm font-black text-[10px] uppercase tracking-widest px-4 h-full">
                <FileEdit size={14} className="mr-2" /> Soạn thảo
              </TabsTrigger>
              <TabsTrigger value="preview" className="rounded-none data-[state=active]:bg-white hover:cursor-pointer data-[state=active]:text-brand-primary data-[state=active]:shadow-sm font-black text-[10px] uppercase tracking-widest px-4 h-full">
                <Eye size={14} className="mr-2" /> Xem trước
              </TabsTrigger>
            </TabsList>
          </Tabs>

          <Button onClick={handleSubmit} disabled={saving} className="bg-brand-primary hover:bg-brand-secondary text-[10px] font-black uppercase tracking-widest px-8 py-4 hover:cursor-pointer h-auto transition-all rounded-none">
