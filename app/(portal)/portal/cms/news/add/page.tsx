                ...
                <div className="flex items-center gap-3">
                    ...
                    >
                        <TabsList className="bg-transparent h-10 gap-1 rounded-none shadow-none p-0">
                            <TabsTrigger
                                value="edit"
                                className="rounded-none data-[state=active]:bg-white data-[state=active]:text-brand-primary data-[state=active]:shadow-sm font-black text-[10px] uppercase tracking-widest px-4 h-full"
                            >
