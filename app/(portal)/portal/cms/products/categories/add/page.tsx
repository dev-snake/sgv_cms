    ...
    <div className="space-y-10">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div className="flex items-center gap-6">
          ...
          <div>
            <h1 className="text-4xl font-black text-slate-900 tracking-tight uppercase leading-none">Thêm danh mục sản phẩm</h1>
            <p className="text-slate-500 font-medium italic mt-2 text-sm">Tạo danh mục phân loại sản phẩm mới với chuẩn SEO và hình ảnh đại diện.</p>
          </div>
        </div>
      </div>
