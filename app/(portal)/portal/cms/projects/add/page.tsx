      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div className="flex items-center gap-6">
          ...
          <div>
            ...
            <p className="text-slate-500 font-medium italic mt-2 text-sm">Thêm dự án hoặc công trình mới vào danh mục.</p>
          </div>
        </div>
        <Button onClick={handleSubmit} className="bg-brand-primary hover:bg-brand-secondary text-[10px] font-black uppercase tracking-widest px-8 py-6 h-auto transition-all rounded-none">
          <Save className="mr-2 size-4" /> Lưu dự án
        </Button>
      </div>
          ...
          <div className="bg-white rounded-none border border-slate-100 p-8 space-y-6">
            ...
            <div className="space-y-3">
              ...
              <Textarea
                ...
                className="min-h-[200px] bg-slate-50 border-none text-sm font-medium rounded-none placeholder:text-slate-300"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-3">
                <Label htmlFor="location" className="text-[10px] font-black uppercase tracking-widest text-slate-500">
                  <MapPin size={12} className="inline mr-1" /> Địa điểm *
                </Label>
                <Input
                  id="location"
              ...
              <div className="space-y-3">
                <Label htmlFor="year" className="text-[10px] font-black uppercase tracking-widest text-slate-500">
                  Năm thực hiện *
                </Label>
                <Input
                  id="year"
