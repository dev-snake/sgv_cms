        ...
        <div className="space-y-8">
            <div>
                ...
                <p className="text-slate-500 font-medium italic mt-1 text-sm">
                    Quản lý cấu hình tài khoản và hệ thống portal.
                </p>
            </div>

            <Tabs defaultValue="profile" className="w-full">
                <TabsList className="grid w-full grid-cols-4 lg:w-[600px] h-12 bg-slate-100 p-1 rounded-none">
                    <TabsTrigger
                        value="profile"
                        className="text-[10px] font-black uppercase tracking-widest rounded-none transition-all data-[state=active]:bg-brand-primary data-[state=active]:text-white"
                    >
                ...
                <TabsContent value="security" className="mt-8">
                    <Card className="border-slate-100 rounded-none overflow-hidden">
                        <CardHeader className="bg-slate-50/50 border-b border-slate-50">
                            ...
                            <CardDescription className="text-xs font-medium italic">
                                Đổi mật khẩu và quản lý các thiết bị đăng nhập.
                            </CardDescription>
                        </CardHeader>
                        ...
                        <CardFooter className="bg-slate-50/30 p-8 border-t border-slate-50 flex justify-end">
                            <Button className="bg-rose-600 hover:bg-rose-700 text-[10px] font-black uppercase tracking-widest px-8 py-6 h-auto shadow-xl shadow-rose-600/20 transition-all rounded-none">
                                Đổi mật khẩu
                            </Button>
                        </CardFooter>
                    </Card>
                ...
                <TabsContent value="website" className="mt-8">
                    <Card className="border-slate-100 rounded-none overflow-hidden">
                        <CardHeader className="bg-slate-50/50 border-b border-slate-50">
                            <CardTitle className="text-sm font-black uppercase tracking-widest text-slate-900">
                                Cấu hình Website chính
                            </CardTitle>
                            <CardDescription className="text-xs font-medium italic">
                                Các cài đặt ảnh hưởng đến hiển thị bên ngoài website.
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="p-8 space-y-6">
                            <div className="space-y-2">
                                ...
                                <Input
                                    defaultValue="SÀI GÒN VALVE - Giải pháp công nghiệp hàng đầu"
                                    className="h-12 border-slate-200 text-xs font-bold rounded-none focus:ring-brand-primary"
                                />
                            </div>
                            <div className="space-y-2">
                                ...
                                <textarea
                                    className="w-full p-4 border border-slate-200 text-xs font-bold rounded-none focus:ring-brand-primary min-h-[100px]"
                                    defaultValue="Chuyên cung cấp các loại van công nghiệp, thiết bị IoT và giải pháp quan trắc chất lượng nước."
                                />
                            </div>
                        </CardContent>
                        <CardFooter className="bg-slate-50/30 p-8 border-t border-slate-50 flex justify-end">
                            <Button className="bg-brand-primary hover:bg-brand-secondary text-[10px] font-black uppercase tracking-widest px-8 py-6 h-auto shadow-xl shadow-brand-primary/20 transition-all rounded-none">
