  ...
  return (
    <div className="space-y-10">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          <h1 className="text-4xl font-black text-slate-900 tracking-tight uppercase leading-none">Tổng quan</h1>
          <p className="text-slate-500 font-medium italic mt-2 text-sm">Chào mừng trở lại. Đây là hoạt động của hệ thống trong 30 ngày qua.</p>
        </div>
          ...
          <Link key={stat.title} href={stat.href}>
            <div className="bg-white p-8 rounded-none border border-slate-100 hover:border-brand-primary/20 hover:bg-slate-50/30 transition-all group relative overflow-hidden">
              ...
              <div className="space-y-6 relative">
                <div className={cn("inline-flex p-4 rounded-none", stat.bg, stat.color)}>
                  <stat.icon size={24} />
                </div>
                <div>
                   <div className="flex items-center justify-between mb-1">
                      <div className="text-[10px] font-black uppercase tracking-[0.15em] text-slate-400">{stat.title}</div>
                      <ArrowUpRight size={14} className="text-slate-300 group-hover:text-brand-primary transition-colors" />
                   </div>
                ...
                <div className="pt-4 border-t border-slate-50 flex items-center justify-between">
                   ...
                   <div className="text-[9px] font-bold text-slate-300 uppercase tracking-widest">Tháng này</div>
                </div>
              </div>
            </div>
          </Link>
             ...
             <div className="grid grid-cols-1 gap-4 relative">
                <Link href="/portal/cms/news" className="flex items-center gap-4 p-5 rounded-none border border-slate-100 hover:border-brand-primary/20 hover:bg-brand-primary/5 transition-all text-left bg-white">
                   ...
                   <div className="space-y-0.5">
                      <div className="text-xs font-black uppercase tracking-tight">Đăng tin tức</div>
                ...
                <Link href="/portal/cms/projects" className="flex items-center gap-4 p-5 rounded-none border border-slate-100 hover:border-brand-primary/20 hover:bg-brand-primary/5 transition-all text-left bg-white">
                   ...
                   <div className="space-y-0.5">
                      <div className="text-xs font-black uppercase tracking-tight">Thêm dự án</div>
                ...
                <Link href="/portal/cms/products" className="flex items-center gap-4 p-5 rounded-none border border-slate-100 hover:border-brand-primary/20 hover:bg-brand-primary/5 transition-all text-left bg-white">
                   ...
                   <div className="space-y-0.5">
                      <div className="text-xs font-black uppercase tracking-tight">Đăng sản phẩm</div>
                      <div className="text-[10px] text-slate-400 font-bold uppercase tracking-widest">Cập nhật Catalog</div>
                   </div>
                </Link>
             </div>
          </div>
          ...
          <div className="bg-linear-to-br from-brand-primary to-brand-secondary rounded-none p-8 text-white border border-white/10 relative overflow-hidden group">
             ...
             <div className="space-y-6 relative">
                ...
                <div className="space-y-2">
                   <h4 className="text-lg font-black uppercase tracking-tight">Xem Website</h4>
                   <p className="text-[11px] text-white/60 font-medium leading-relaxed">Kiểm tra hiển thị nội dung vừa cập nhật trực tiếp trên website chính thức của Sài Gòn Valve.</p>
                </div>
